...
public class BloomFilter<E> implements Serializable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1636645303797813627L;
	 ...
	 * @param
	 */
	public void add(BloomFilter<E> bf) {
	...
	public static void main(String[] args) {
		...
		BloomFilter<String> bf = new BloomFilter<String>(0.1, 100000000);
		for (int i = 0; i < 73554; i++) {
			bf.add("fooooooooo" + i);
		}
		for (int i = 0; i < 73554; i++) {
			System.out.println(bf.contains("fooooooooo" + i));
		}
		
//		writeObject("d:/d12/bf", bf);
//
//		if (bf.contains("fooooooooo143523")) { // Always returns true
